...
9. Optional Gate 2 recheck:
   npm.cmd run gate2:check

10. Optional PVI authorized-path check:
   set INTERNAL_PVI_API_TOKEN locally and rerun:
   npm.cmd run report:runtime

11. Send Codex only summaries, WARN/FAIL lines, or SQL errors.
