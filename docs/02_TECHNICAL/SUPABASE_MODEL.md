...
| `activity_drafts` | Draft Inbox interno | Internal | Requiere `internal_tool_access`. |
...
Contrato principal del catálogo. El frontend lo consume desde `catalogService.js` y espera campos como título, centro, ciudad, categoría, tipo, descripción, imagen, edad, precio, horario y venue.
...
- `activity_drafts`: revisión editorial.
